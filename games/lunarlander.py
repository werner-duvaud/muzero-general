...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (1, 1, 8)  # Dimensions of the game observation, must be 3. For a 1D array, please reshape it to (1, 1, length of array)
        ...
        self.td_steps = 500  # Number of steps in the futur to take into account for calculating the target value
...
class Game:
    ...
    def step(self, action):
        ...
        return numpy.array([[observation]]), reward/2, done
