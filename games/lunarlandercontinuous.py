...
class MuZeroConfig:
    def __init__(self):
        ...
        self.action_space = numpy.ones(numJoints) #models.py just does len of this variable to determine the action space  #range of action space doesn't matter because gaussian network will create actions without regard to limits  # Fixed list of all possible actions. You should only edit the length
        ...
        self.fc_dynamics_layers = [400,300]  # Define the hidden layers in the dynamics network
        self.fc_reward_layers = [400,300]  # Define the hidden layers in the reward network
        self.fc_value_layers = [400,300]  # Define the hidden layers in the value network
        self.fc_policy_layers = [400,300]  # Define the hidden layers in the policy network
...
class Game(AbstractGame):
    ...
    def __init__(self, seed=None):
        self.env = LunarLanderContinuous()
        if seed is not None:
            self.env.seed(seed)
